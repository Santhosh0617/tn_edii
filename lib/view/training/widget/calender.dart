...
class _CalenderState extends State<Calender> {
  ...
  void initState() {
    WidgetsBinding.instance
        .addPostFrameCallback((t) => getDates(CustomDateTime().now));
    super.initState();
  }
          ...
          children: [
            ...
            GridView.builder(
              ...
              itemBuilder: (context, index) {
                Day date = days[index];
                bool hadEvent = value.myCourses.any((e) =>
                    e.training?.startDate.toString().yyyyMMdd == date.fullDate);
                return InkWell(
  ...
  void getDates(DateTime dateTime) {
    ...
    courseProvider.selectedMonthCourses = courseProvider.myCourses
        .where((e) =>
            e.training?.startDate
                .toString()
                .strToDate
                .isSameMonth(selectedDate) ??
            false)
        .toList();
    int nextMonthCount =
